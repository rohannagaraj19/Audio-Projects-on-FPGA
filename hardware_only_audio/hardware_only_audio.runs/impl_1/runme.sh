...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/hardware_only_audio/hardware_only_audio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_only_audio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_only_audio.tcl -notrace
