...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/hardware_only_audio/hardware_only_audio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_only_audio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_only_audio.tcl
