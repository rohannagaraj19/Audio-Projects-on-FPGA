...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/audio_synth/audio_synth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audioTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audioTop.tcl -notrace
