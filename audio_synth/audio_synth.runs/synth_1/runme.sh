...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/audio_synth/audio_synth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audioTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audioTop.tcl
